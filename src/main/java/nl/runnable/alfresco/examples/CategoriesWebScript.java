...
public class CategoriesWebScript {
   ...
   * <p>
   * The {@link AlfrescoService} annotation lets you control whether you want the default (high-level) implementation of
   * a service or, as in this case, the low-level version. Low-level versions are typically faster, as they are not
